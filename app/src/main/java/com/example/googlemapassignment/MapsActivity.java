...
public class MapsActivity extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autocompleteSupportFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                addMarkerTOSearchedPlace(place);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.current_loc_menu_id) {
            showCurrentPlace();
        }
        return true;
    }
    ...
    // set a market to selected place
    private void addMarkerTOSearchedPlace(Place place) {
        if (place.getLatLng() != null) {
            searchedLatitude = place.getLatLng().latitude;
            searchedLongitude = place.getLatLng().longitude;

            // add a marker to destination place
            map.addMarker(new MarkerOptions().position(place.getLatLng()).title(place.getName()));
            map.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(searchedLatitude, searchedLongitude), 13));
